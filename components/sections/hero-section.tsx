...
export default function HeroSection() {
  return (
    <section className='h-[70vh] w-full relative'>
      <main className="flex flex-col max-md:gap-20 md:flex-row items-center justify-center md:justify-between container mx-auto h-full overflow-hidden">
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex items-center gap-4 mt-8 text-sm">
            <Button className="bg-[#0088FF] hover:bg-[#0088FF] text-white active:scale-95 transition rounded-md px-7 h-11">
              Create an account
            </Button>
          </div>
        </div>
        ...
        />
        <div className="h-full z-99 py-12 hidden md:block">
